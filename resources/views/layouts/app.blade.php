...
<body class="h-full bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200" x-data="{ sidebarOpen: false }">
    <div class="min-h-full">
        {{-- Sidebar --}}
        <div class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 dark:bg-gray-950 border-r border-transparent dark:border-gray-800 transform transition-transform duration-200 ease-in-out lg:translate-x-0 -translate-x-full shadow-2xl lg:shadow-none"
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-800">
                ...
                {{-- Mobile Close Button --}}
                <button type="button" @click="sidebarOpen = false" class="lg:hidden text-gray-400 hover:text-white transition-colors">
